...
import com.donnan.git.guru.base.response.ResponseCode;
import com.donnan.git.guru.base.utils.BeanValidator;
...
public class FacadeAspect {
    ...
    @Around("@annotation(com.donnan.git.guru.rpc.facade.Facade)")
